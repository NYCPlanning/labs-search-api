...
describe("GET /search", () => {
  it("should respond with searches that match the specified address", (done) => {
    chai
      .request(server)
      .get(
        "/search?helpers[]=geosearch-v2&helpers[]=neighborhood&helpers[]=bbl&helpers[]=zoning-district&helpers[]=zoning-map-amendment&helpers[]=special-purpose-district&helpers[]=commercial-overlay&q=120%20broadway"
      )
      .end((err, res) => {
